...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { adjunto: @contacto.adjunto, contenido: @contacto.contenido, titulo: @contacto.titulo }
    end
  ...
  test "should update contacto" do
    put :update, id: @contacto, contacto: { adjunto: @contacto.adjunto, contenido: @contacto.contenido, titulo: @contacto.titulo }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
