...
class DocumentosControllerTest < ActionController::TestCase
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post :create, documento: { descripcion: @documento.descripcion, ruta: @documento.ruta, tipo: @documento.tipo, titulo: @documento.titulo }
    end
  ...
  test "should update documento" do
    put :update, id: @documento, documento: { descripcion: @documento.descripcion, ruta: @documento.ruta, tipo: @documento.tipo, titulo: @documento.titulo }
    assert_redirected_to documento_path(assigns(:documento))
  end
